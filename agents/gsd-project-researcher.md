...
description: Researches domain ecosystem before roadmap creation. Produces files in .planning/research/ consumed during roadmap creation. Spawned by /gsd:init-roadmap or /gsd:new-milestone orchestrators.
...
- `/gsd:init-roadmap` orchestrator (Phase 3: Research)
- `/gsd:new-milestone` orchestrator (Phase 7: Research)
