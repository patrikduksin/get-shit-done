 ...
 */
export async function findPitfalls(options) {
    ...
    if (options.query) {
        ...
        filtered = allPitfalls.filter(p => p.name.toLowerCase().includes(query) ||
 ...
 */
function findResearchFiles(dir, files = []) {
    try {
...
//# sourceMappingURL=pitfalls.js.map