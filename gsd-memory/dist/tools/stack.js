 ...
 */
export async function findStack(options) {
    ...
    if (options.query) {
        ...
        filtered = allStack.filter(s => s.library.toLowerCase().includes(query) ||
 ...
 */
function extractFromSummaries(planningPath, projectName) {
    const stack = [];
 ...
 */
function extractFromResearch(planningPath, projectName) {
    const stack = [];
